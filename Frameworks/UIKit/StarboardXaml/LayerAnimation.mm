...
public:
    ...
    concurrency::task<void> AddToNode(ILayerProxy& node) {
        ...
        return _AddTransitionAnimation(node, [_type UTF8String], [_subType UTF8String]);
    }
...
public:
    ...
    concurrency::task<void> AddToNode(ILayerProxy& node) {
        ...
        if (strcmp(propName, "transform.scale") == 0) {
            ...
            _AddAnimation(node, L"transform.scale.x", _fromValue != nil, fromValue, _toValue != nil, toValue);
            _AddAnimation(node, L"transform.scale.y", _fromValue != nil, fromValue, _toValue != nil, toValue);
            _Start();
            ...
            _AddAnimation(node, L"transform.rotation", _fromValue != nil, fromValue, _toValue != nil, toValue);
            _Start();
            ...
            _AddAnimation(node, L"transform.translation.x", _fromValue != nil, fromValue, _toValue != nil, toValue);
            _Start();
            ...
            _AddAnimation(node, L"transform.translation.y", _fromValue != nil, fromValue, _toValue != nil, toValue);
            _Start();
            ...
            _AddAnimation(node, L"position.x", _fromValue != nil, fromValue.x, _toValue != nil, toValue.x);
            _AddAnimation(node, L"position.y", _fromValue != nil, fromValue.y, _toValue != nil, toValue.y);
            _Start();
            ...
            _AddAnimation(node, L"origin.x", _fromValue != nil, fromValue.origin.x, _toValue != nil, toValue.origin.x);
            _AddAnimation(node, L"origin.y", _fromValue != nil, fromValue.origin.y, _toValue != nil, toValue.origin.y);
            _AddAnimation(node, L"size.width", _fromValue != nil, fromValue.size.width, _toValue != nil, toValue.size.width);
            _AddAnimation(node, L"size.height", _fromValue != nil, fromValue.size.height, _toValue != nil, toValue.size.height);
            _Start();
        } else if (strcmp(propName, "opacity") == 0) {
            _AdjustFloatValuesForKeyPath(_propertyName);
            float fromValue = [(NSNumber*)_fromValue floatValue];
            float toValue = [(NSNumber*)_toValue floatValue];
            _AddAnimation(node, L"opacity", _fromValue != nil, fromValue, _toValue != nil, toValue);
            _Start();
            ...
            if (scaleFrom[0] != 1.0f || scaleFrom[1] != 1.0f || scaleTo[0] != 1.0f || scaleTo[1] != 1.0f) {
                _AddAnimation(node, L"transform.scale.x", isValid, scaleFrom[0], isValid, scaleTo[0]);
                _AddAnimation(node, L"transform.scale.y", isValid, scaleFrom[1], isValid, scaleTo[1]);
            }
            if (translationFrom[0] != 0.0f || translationFrom[1] != 0.0f || translationTo[0] != 0.0f || translationTo[1] != 0.0f) {
                _AddAnimation(node, L"transform.translation.x", isValid, translationFrom[0], isValid, translationTo[0]);
                _AddAnimation(node, L"transform.translation.y", isValid, translationFrom[1], isValid, translationTo[1]);
            }
            if (angleFrom != 0.0f || angleTo != 0.0f) {
                _AddAnimation(node, L"transform.rotation", isValid, angleFrom, isValid, angleTo);
            }
            _Start();
        } else if (strcmp(propName, "transform.translation.y") == 0) {
            _AdjustFloatValuesForKeyPath(_propertyName);
