...
- (void)adjustTextLayerSize {
    ...
    switch (_lineBreakMode) {
        case UILineBreakModeWordWrap:
            [_textBlock setTextWrapping:WXTextWrappingWrapWholeWords];
            break;
        ...
        case UILineBreakModeClip:
            [_textBlock setTextWrapping:WXTextWrappingNoWrap];
            [_textBlock setTextTrimming:WXTextTrimmingClip];
            break;
        ...
        case UILineBreakModeTailTruncation:
            [_textBlock setTextWrapping:WXTextWrappingNoWrap];
            [_textBlock setTextTrimming:WXTextTrimmingCharacterEllipsis];
            break;
    }
